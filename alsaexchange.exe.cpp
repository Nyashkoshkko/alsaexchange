...
// 	// создаем экземпляр класса окна // linux: 260 is settings width
    ...
    //группа сохранения мастер стрима
    ...
    {
        SendMessage(H_MIDILIST, CB_ADDSTRING, 0, (LPARAM)(MidiInNames[i]) ); // Добавление пункта
    }
    SendMessage(H_MIDILIST, CB_SETCURSEL, MIDICurrentIndex, 0); // Выбор текущего элемента списка
